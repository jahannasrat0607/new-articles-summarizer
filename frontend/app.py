...
import os
# FastAPI backend URL
# Determine if running locally or on Hugging Face

if "HUGGINGFACE_SPACE" in os.environ:
    API_URL = "https://jahan0607-news-articles-summarizer.hf.space/fetch_news"  # Hugging Face API
else:
    API_URL = "http://127.0.0.1:7860/fetch_news"  # Local FastAPI server
